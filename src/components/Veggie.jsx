...
function Veggie() {
  ...
  const getVeggie = async () => {
    ...
    const cachedData = localStorage.getItem("veggie");
    if (cachedData) {
    ...
    try {
        ...
        const response = await fetch(
            `https://api.spoonacular.com/recipes/random?apiKey=${import.meta.env.VITE_MY_API_KEY}&number=9&tags=vegetarian`
        );
